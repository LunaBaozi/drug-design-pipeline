...
rule prepare_EB_input:
    ...
    output:
        f"external/equibind/data/{{pdbid}}/experiment_{{experiment}}_{{epoch}}_{{num_gen}}_{{known_binding_site}}_{{pdbid}}/ligands/multiligand.sdf"
...
rule prepare_receptor:
    input:
        ...
        f"external/equibind/data/{{pdbid}}/experiment_{{experiment}}_{{epoch}}_{{num_gen}}_{{known_binding_site}}_{{pdbid}}/ligands/multiligand.sdf"
    output:
        f"external/equibind/data/{{pdbid}}/experiment_{{experiment}}_{{epoch}}_{{num_gen}}_{{known_binding_site}}_{{pdbid}}/ligands/{{pdbid}}_A_rec_reduce_noflip.pdb"
        # prepared="results/equibind/{sample}_prepared.pkl"
    params:
        experiment = "{experiment}",
        epoch = "{epoch}",
...
rule run_equibind:
    input:
        receptor=f"external/equibind/data/{{pdbid}}/experiment_{{experiment}}_{{epoch}}_{{num_gen}}_{{known_binding_site}}_{{pdbid}}/ligands/{{pdbid}}_A_rec_reduce_noflip.pdb",
        multiligand=f"external/equibind/data/{{pdbid}}/experiment_{{experiment}}_{{epoch}}_{{num_gen}}_{{known_binding_site}}_{{pdbid}}/ligands/multiligand.sdf"
    output:
        # ligands_dir=directory(f"external/equibind/results/experiment_{{experiment}}_{{epoch}}_{{num_gen}}_{{known_binding_site}}_{{pdbid}}/ligands")
    ...
    shell:
        ...
        python multiligand_inference.py \
            -o {params.output_dir_rel} \
            -r {params.receptor_rel} \
