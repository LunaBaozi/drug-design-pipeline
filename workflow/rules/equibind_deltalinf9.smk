...
rule prepare_EB_input:
    ...
    output:
        f"results/experiment_{{experiment}}_{{epoch}}_{{num_gen}}_{{known_binding_site}}_{{pdbid}}/ligands/multiligand.sdf"
...
rule prepare_receptor:
    input:
        ...
        f"results/experiment_{{experiment}}_{{epoch}}_{{num_gen}}_{{known_binding_site}}_{{pdbid}}/ligands/multiligand.sdf"
    output:
        f"results/experiment_{{experiment}}_{{epoch}}_{{num_gen}}_{{known_binding_site}}_{{pdbid}}/ligands/{{pdbid}}_A_rec_reduce_noflip.pdb"
        # prepared="results/equibind/{sample}_prepared.pkl"
    params:
        experiment = "{experiment}",
        epoch = "{epoch}",
...
rule run_equibind:
    input:
        receptor=f"results/experiment_{{experiment}}_{{epoch}}_{{num_gen}}_{{known_binding_site}}_{{pdbid}}/ligands/{{pdbid}}_A_rec_reduce_noflip.pdb",
        multiligand=f"results/experiment_{{experiment}}_{{epoch}}_{{num_gen}}_{{known_binding_site}}_{{pdbid}}/ligands/multiligand.sdf"
    output:
        # ligands_dir=directory(f"results/experiment_{{experiment}}_{{epoch}}_{{num_gen}}_{{known_binding_site}}_{{pdbid}}/ligands")
        f"results/experiment_{{experiment}}_{{epoch}}_{{num_gen}}_{{known_binding_site}}_{{pdbid}}/ligands/failed.txt",
        f"results/experiment_{{experiment}}_{{epoch}}_{{num_gen}}_{{known_binding_site}}_{{pdbid}}/ligands/output.sdf",
        f"results/experiment_{{experiment}}_{{epoch}}_{{num_gen}}_{{known_binding_site}}_{{pdbid}}/ligands/success.txt"
    params:
        experiment = "{experiment}",
        epoch = "{epoch}",
        num_gen = "{num_gen}",
    ...
    shell:
        ...
        python multiligand_inference.py \
            -o ../../results/experiment_{wildcards.experiment}_{wildcards.epoch}_{wildcards.num_gen}_{wildcards.known_binding_site}_{wildcards.pdbid}/ligands/ \
            -r ../../results/experiment_{wildcards.experiment}_{wildcards.epoch}_{wildcards.num_gen}_{wildcards.known_binding_site}_{wildcards.pdbid}/ligands/{wildcards.pdbid}_A_rec_reduce_noflip.pdb \
            -l ../../results/experiment_{wildcards.experiment}_{wildcards.epoch}_{wildcards.num_gen}_{wildcards.known_binding_site}_{wildcards.pdbid}/ligands/multiligand.sdf 
        """
...
rule postprocess_equibind:
    input:
        ...
        output_sdf=f"results/experiment_{{experiment}}_{{epoch}}_{{num_gen}}_{{known_binding_site}}_{{pdbid}}/ligands/output.sdf",
        success_txt=f"results/experiment_{{experiment}}_{{epoch}}_{{num_gen}}_{{known_binding_site}}_{{pdbid}}/ligands/success.txt",
        receptor_pdb=f"results/experiment_{{experiment}}_{{epoch}}_{{num_gen}}_{{known_binding_site}}_{{pdbid}}/ligands/{{pdbid}}_A_rec_reduce_noflip.pdb"
    output:
    ...
    params:
        ...
        equibind_path = lambda wildcards: config['modules']['equibind']['path'],
        vina_path = lambda wildcards: config['modules']['vina_box']['path'],
        input_dir = lambda wildcards: f"results/experiment_{wildcards.experiment}_{wildcards.epoch}_{wildcards.num_gen}_{wildcards.known_binding_site}_{wildcards.pdbid}",
